...
import static Halen3.GUI.Manga.MangaGUIControls.initmangaControls;
...
public class MangaGUI
{
    ...
    public static void addMangaPanel(int width, int height, int x, int y)
    {
        ...
        mangaPanel.setSize(width, height);
        mangaPanel.setLocation(x, y);
        mangaPanel.setBackground(secondary);
        mangaPanel.setLayout(null);
        ...
        issueListPane.setSize(mangaPanel.getWidth() / 3, mangaPanel.getHeight());
        //issueListPane.setLocation((int) (search.getX() + search.getWidth() + search.getHeight() / 6), cb.getY());
        issueListPane.setLocation(mangaPanel.getWidth() - issueListPane.getWidth(), 0);
        ...
        rulesPane.setSize(mangaPanel.getWidth() / 3, mangaPanel.getHeight());
        ...
        {
            Logger.getLogger(MangaGUI.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        mangaURL.setText(" manga URL ");
        mangaURL.setEditable(false);
        mangaURL.setFont(mangaURL.getFont().deriveFont(Font.BOLD));
        mangaURL.setForeground(primary);
        mangaURL.setBackground(secondary);
        mangaURL.setBorder(null);
        mangaURL.setSize(ruleName.getWidth(), ruleName.getHeight());
        mangaURL.setLocation(ruleName.getLocation().x, ruleName.getLocation().y + ruleName.getHeight());
        mangaURL.setVisible(true);

        mangaURLInput = new JTextField(20);
        mangaURLInput.setText("...");
        mangaURLInput.setEditable(true);
        mangaURLInput.setFont(mangaURLInput.getFont().deriveFont(Font.BOLD));
        mangaURLInput.setBorder(border);
        mangaURLInput.setForeground(primary);
        mangaURLInput.setBackground(secondary.brighter());
        mangaURLInput.setCaretColor(primary);
        mangaURLInput.setSize(ruleNameInput.getWidth(), ruleName.getHeight());
        mangaURLInput.setLocation(mangaURL.getLocation().x + mangaURL.getWidth(), mangaURL.getLocation().y);
        mangaURLInput.setVisible(true);
        ...
        DownloadToFolder.setLocation(mangaURL.getX(), mangaURL.getY() + mangaURL.getHeight());
...
//        dividerThree.setLocation(mangaURL.getX(), searchForText.getY() + searchForText.getHeight());
...
//        withThisText.setVisible(true);
    ...
    public static void refreshMangaPanel()
    {
        //blank rules in ui
    ...
    private static void createRuleButtons() throws IOException
    {
        ...
        File[] rulesList = null;
        //load tv show rules
        File folder = new File(Halen3.IO.FileManager.launchPath() + "/rules/manga");
        //only load xml files,
        ...
        for (int i = 0; i < rulesList.length; i += 3)
        {
            ...
            addmangaButton(rulesList, background, i, 0, 0);
    ...
    private static void addmangaButton(File rulesList[], JPanel parent, int i, int x, int y) throws FileNotFoundException, IOException
    {
        final JButton button = new JButton();
...
//        File[] rulesList = null;
//        //load tv show rules
//        File folder = new File(halen.FileManager.launchPath() + "/rules/Manga");
//        //only load xml files,
//        rulesList = folder.listFiles(new FileFilter()
//        {
//            @Override
...
//    }
    ...
    private static void loadSequenceContent(final String file)
    {
        ...
        final List data = FileManager.readFile(FileManager.launchPath() + "/rules/Manga/" + file + ".xml");
                ...
                button.addMouseListener(new MouseListener()
                {
                    ...
                    public void mouseClicked(MouseEvent me)
                    {
                        ...
                        try
                        {
                            ...
                            out = new PrintWriter(FileManager.launchPath() + "/rules/Manga/" + file + ".xml");
