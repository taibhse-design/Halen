...
//        }});
        ...
        cancel.setSize(colsetup.getWidth() / 9, colsetup.getWidth() / 9);
        ...
        accept.setSize(colsetup.getWidth() / 9, colsetup.getWidth() / 9);
...
//        });
        ...
        cancel.addMouseListener(new MouseListener()
        {
            ...
            public void mouseClicked(MouseEvent me)
            {
                ...
                GUIBase.film.setVisible(true);
                GUIBase.comics.setVisible(true);
                GUIBase.manga.setVisible(true);
